...
def convertToUni(modifiedString, font):
	...
	while continu == 1:
		...
		#processedText = re.sub(r'(प्)(asd|ँ|ं|़)(ा|ि|ी|ु|ू|ृ|े|ै|ो|ौ|ं|ँ|़|्र)+',r'\1\3\2',processedText)
		processedText = re.sub(r'(क|ख|ग|घ|ङ|च|छ|ज|झ|ञ|ट|ठ|ड|ढ|ण|त|थ|द|ध|न|प|फ|ब|भ|म|य|र|ल|ळ|व|श|ष|स|ह)(junk|्)*(asd|ँ|ं|़)+(ा|ि|ी|ु|ू|ृ|े|ै|ो|ौ|ं|ँ|़|्र)',r'\1\4',processedText)
		return processedText
inp=raw_input()
print convertToUni(inp,1)
